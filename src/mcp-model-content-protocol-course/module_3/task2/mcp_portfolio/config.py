"""Configuration for the MCP Enterprise Integration Portfolio server.

Every configurable value lives here via pydantic-settings (env prefix MCP_PORTFOLIO_).
...
class Settings(BaseSettings):
    model_config = SettingsConfigDict(
        env_prefix="MCP_PORTFOLIO_", env_file=".env", extra="ignore"
    )
